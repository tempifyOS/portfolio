    ...
    return (
        ...
        >
            ...
            <div className={css.imageContainer}>
                {images.map(({ key, url, hover, h, w, className }, index) => {
                    const hoverEffect = (hover === 'left') ? hoverLeft : hoverRight;
                    return (
                        <span key={index} className={`${css[className]}`}>
                            <m.div key={`${index}-${key}`} variants={item}>
                                <m.div variants={hoverEffect}>
